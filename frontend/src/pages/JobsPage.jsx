                ...
                <div style={styles.modal} onClick={() => setShowApplyForm(false)}>
                    <div style={styles.modalContent} onClick={e => e.stopPropagation()}>
                        ...
                        <form onSubmit={handleSubmitApplication}>
                            ...
                            <input type="text" name="current_ctc" placeholder="Current CTC (e.g., 5 LPA)" value={formData.current_ctc} onChange={handleInputChange} style={styles.input} />
                            <input type="text" name="notice_period" placeholder="Notice Period (e.g., 30 days)" value={formData.notice_period} onChange={handleInputChange} style={styles.input} />
...
export default JobsPage;  // ← MAKE SURE THIS LINE EXISTS