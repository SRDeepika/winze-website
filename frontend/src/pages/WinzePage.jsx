...
// Detailed content for each solution card
                            ...
                            <div>
                                ...
                                <form onSubmit={handleQuoteSubmit} style={{ maxWidth: '500px', margin: '0 auto' }}>
                                    <input
                                        ...
                                        style={{ width: '100%', padding: '14px', marginBottom: '15px', borderRadius: '10px', border: 'none', fontSize: '16px' }}
                                    />
                                    <input
                                        type="email"
                                    ...
                                    <textarea
                                        ...
                                        style={{ width: '100%', padding: '14px', marginBottom: '20px', borderRadius: '10px', border: 'none', fontSize: '16px', resize: 'vertical' }}
                                    ></textarea>
    ...
    return (
        <HelmetProvider>
            ...
            <div style={{ fontFamily: "'Poppins', 'Montserrat', sans-serif", overflowX: 'hidden', position: 'relative' }}>
                ...
                {/* Navigation Bar - Fixed to right side */}
                <nav style={{
                    position: 'sticky',
                    top: 0,
                    left: 0,
                                ...
                                >
                                    ...
                                    <button 
                                        ...
                                        onClick={(e) => {
                                            ...
                                            // For delivery items, we don't have detailed content yet
                                            alert(`More details about ${item.title} coming soon. Please contact us for more information.`);
                                        }}
                                    >
                                        Learn More →
                                    </button>
                                    ...
                                    <div className="industry-card-content">
                                        ...
                                        <button 
                                            ...
                                            onClick={() => {
                                                ...
                                                alert(`More details about ${industry.name} solutions coming soon. Please contact us for more information.`);
                                            }}
                                        >
                                            Learn More →
                                        </button>
