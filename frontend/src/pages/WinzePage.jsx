...
const WinzePage = () => {
    ...
    <button key={item.name} onClick={(e) => { 
        ...
        e.stopPropagation(); 
        if (item.path) {
            handleTrackClick('Careers Page Visit', 'navigation');  // ← ADD THIS
